...
def get_all_todos() -> List[Todo]:
    ...
    for result in results:
        todos.append(Todo(
            *result))  # this will basically unpack all the arguments and place those in the constructor of our Todos class
    return todos
    ...
    with conn:
        ...
        for pos in range(position + 1, count):
            change_position(pos, pos - 1,
                            False)  # see, here commit is False, means it will not commit at each for loop changes.
